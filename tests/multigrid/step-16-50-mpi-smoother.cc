...
namespace Step50
{
  ...
  LaplaceProblem<dim>::solve()
  {
    ...
    // coarse grid solver:
    MGSmootherPrecondition<matrix_t, Smoother, vector_t> mg_coase_grid_smoother;
    mg_coase_grid_smoother.initialize(mg_matrices,
                                      Smoother::AdditionalData(0.5));
    mg_coase_grid_smoother.set_steps(2);
    mg_coase_grid_smoother.set_symmetric(true);
